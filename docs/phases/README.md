...
| [M8](phase-8-access-rules.md) (built) | Access rules | Per-table read/write access (Public / Signed-in / Admin) set in the project and enforced by the exported backend | M6, M7 |
| [M9](phase-9-realtime-export.md) (built) | Realtime in the export | Subscribe to table changes (SignalR) in the generated backend; M8's read level decides who may subscribe | M8 |
